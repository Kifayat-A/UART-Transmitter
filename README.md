...
The design allows a user agent (CPU / Core / DMA) to write data into the FIFO while the UART transmitter automatically dequeues and transmits data over the TX line at the selected baud rate until the FIFO becomes empty.
